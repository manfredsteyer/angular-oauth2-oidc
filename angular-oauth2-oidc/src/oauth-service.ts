...
import { Observable, Subject, Subscription, of as observableOf, race } from 'rxjs';
...
import { filter, delay, first, tap, map } from 'rxjs/operators';
...
export class OAuthService
    ...
    private setupAccessTokenTimer(): void {
        ...
        this.accessTokenTimeoutSubscription =
            observableOf(new OAuthInfoEvent('token_expires', 'access_token'))
                .pipe(delay(timeout))
    ...
    private setupIdTokenTimer(): void {
        ...
        this.idTokenTimeoutSubscription =
            observableOf(new OAuthInfoEvent('token_expires', 'id_token'))
                .pipe(delay(timeout))
                .subscribe(e => this.eventsSubject.next(e));
    }
    ...
    public silentRefresh(params: object = {}): Promise<OAuthEvent> {
        ...
        */
        ...
        let timeout = observableOf(new OAuthErrorEvent('silent_refresh_timeout', null))
